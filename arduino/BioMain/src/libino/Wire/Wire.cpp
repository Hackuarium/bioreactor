...
uint8_t TwoWire::requestFrom(uint8_t address, uint8_t quantity,
                             ...
                             uint8_t sendStop) {
  if (isize > 0) {
    // send internal address; this mode allows sending a repeated start to
    // access some devices' internal registers. This function is executed by the
    // hardware TWI module on other processors (for example Due's TWI_IADR and
    // TWI_MMR registers)
