...
F 0 "JP14" V 2175 8225 59  0000 L CNN
F 1 "IO4" V 2050 8250 59  0000 L CNN
F 2 "Connector_Molex:Molex_KK-254_AE-6410-02A_1x02_P2.54mm_Vertical" H 2100 8125 50  0001 C CNN
...
F 0 "D20" H 1450 8850 50  0000 C CNN
F 1 "RED" H 1450 9025 50  0000 C CNN
F 2 "LED_SMD:LED_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 1450 8925 50  0001 C CNN
...
F 0 "R54" V 1150 8600 50  0000 L CNN
F 1 "10k" V 1225 8650 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 1155 8725 50  0001 C CNN
F 3 "~" H 1225 8725 50  0001 C CNN
	1    1225 8725
	1    0    0    -1  
$EndComp
Text GLabel 4425 4250 2    50   Input ~ 0
A4
Text GLabel 1050 8525 0    50   Input ~ 0
A4
Wire Wire Line
	1225 8575 1225 8525
Wire Wire Line
...
U 1 1 5F75493A
P 1950 9075
F 0 "#0102" H 2000 9125 50  0001 C CNN
F 1 "GND" H 2053 9113 42  0000 L CNN
F 2 "" H 1950 9075 50  0001 C CNN
...
U 1 1 5F4A21DB
P 1950 8525
F 0 "Q8" H 2056 8571 50  0000 L CNN
F 1 "ZXMS6004" H 2056 8480 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 2050 8450 50  0001 L CIN
F 3 "https://www.diodes.com/assets/Datasheets/ZXMS6004FF.pdf" H 2050 8600 50  0001 L CNN
	1    1950 8525
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F4A3E1A
P 1675 8725
AR Path="/5E02557B/5F4A3E1A" Ref="C?"  Part="1" 
AR Path="/5F4A3E1A" Ref="C38"  Part="1" 
F 0 "C38" H 1425 8700 50  0000 L CNN
F 1 "100n" H 1475 8625 50  0000 L CNN
F 2 "Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 1713 8575 50  0001 C CNN
F 3 "~" H 1675 8725 50  0001 C CNN
	1    1675 8725
	-1   0    0    -1  
$EndComp
Text GLabel 1850 8125 0    55   Input ~ 0
12V
Wire Wire Line
	1750 8525 1675 8525
Wire Wire Line
...
Connection ~ 1225 8525
Wire Wire Line
	1675 8875 1675 8925
Connection ~ 1675 8925
Wire Wire Line
	1950 8725 1950 8925
Wire Wire Line
	1675 8925 1950 8925
Connection ~ 1950 8925
Wire Wire Line
	1950 8925 1950 8975
Wire Wire Line
	2000 8125 1850 8125
